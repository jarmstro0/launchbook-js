...
let toChange = favorites.getElementsByTagName('h5')[0]
toChange.innerHTML = "Least Favs"
...
let ad = document.getElementsByClassName("ad-slot")[1].getElementsByTagName('img')[0]
ad.setAttribute("src", "http://placebear.com/200/300")

// Exercise 8): Find Sam's post and change its text to something incredible.
let sam = document.getElementsByClassName("media-body")[4]
sam.getElementsByTagName("p")[0].innerHTML = "Something Incredible!"

// Exercise 9): Find the first post and add the `.post-liked` class to it, and watch it turn blue.
let adam = document.getElementsByClassName("media-body")[1]
adam.setAttribute("class", "post-liked")

// Exercise 10: Find the second post and add the `.post-shared` class to the `li` containing the text Shared to watch it turn red.
let eric = document.getElementsByClassName("post-actions")[1]
eric.getElementsByTagName("li")[2].setAttribute("class", "post-shared")
